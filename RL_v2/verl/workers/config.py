...
class WorkerConfig:
    ...
    def post_init(self):
        ...
        # Propagate FutureL1 kappa from actor to ref (the ref-policy log-prob
        # is computed with the same vMF concentration to keep the ratio sane).
        self.ref.future_l1_rl_kappa = self.actor.future_l1_rl_kappa
