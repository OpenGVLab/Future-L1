#!/usr/bin/env bash
# Local 8-GPU GRPO: V1-33K-RL-2K + 0519-TwiFF-interleave SFT checkpoint.
# Run inside an rlaunch / interactive GPU node (same mounts as train.sh).
#
# Usage:
#   cd ${VIDEO_L1_ROOT}/RL_v2
#   bash examples/run_grpo_v133k2k_0519_local.sh
set -euo pipefail
...
apply_v133k2k_run_output_defaults grpo
...
exec bash "${RL_V2_ROOT}/train.sh" grpo
